#! /usr/bin/python3
# RandomQuizGen.py - Random Quiz with Four Choice and Answer
import random
...
for quizno in range(35)
	...
	quizFile=open('capitalquiz%s.txt' %(quizno + 1),'w')
	answerKeyFile=open('capitalquiz_answers%s.txt' % (quizno+1),'w')
